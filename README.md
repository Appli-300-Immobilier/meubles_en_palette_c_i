# Meubles en Palette C.i - Plateforme Immobilière Premium

Bienvenue sur le dépôt du code source de l'application web **Meubles en Palette C.i**. Ce projet est une solution complète (Site Vitrine + Catalogue de Biens + Administration) développée avec des technologies modernes pour le secteur de l'immobilier en Côte d'Ivoire.
...
* **Contact :** +225 0758986069
* **Email :** contact@meublesenpaletteci.cm
* **Social :** [Facebook](https://facebook.com) | [WhatsApp](https://wa.me/2250758986069)
